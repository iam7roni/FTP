namespace FTP_Server
{
	...
	public class FTPServer
    {
					...
					if(!bClose)
					{
						...
						switch(strSwitchExpression)
						{
							...
							case "PASV":
								Console.ClientConnect(ClientID,clientMsg);
								FTPDataListner=null;
								int intPassivePort=(ref FTPDataListner);
        ...
        private NetworkStream Mode(bool PassiveMode, ref TcpClient FTPDataClient, ref Socket PassiveClientDataSocket, string strIP, int Port)
        {
            throw new NotImplementedException();
        }

        private int PassiveModePort(ref TcpListener FTPDataListner)
        {
            throw new NotImplementedException();
        }
